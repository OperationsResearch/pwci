...
// 14/11/18: addded param infotooltip                                         //
// -------------------------------------------------------------------------- //
// COMMENTS:                                                                  //
...
//        throw new Exception("Can not find session for user");
    ...
    public function setConfig($variable, $value) {
      if ($variable == "location") {
        ...
        //if (!telegramTools::get_settings_item("location")) { telegramTools::save_settings_item("location", $value); }
...
$this->spacesbody          <div class=\"img\"><span>profilePicture</span><span class=\"tooltip\" ng-bind-html=\"'".$this->infotooltip." ' + (message.helper)\"></span></div>
